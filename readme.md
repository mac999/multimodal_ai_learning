...
This repository provides a comprehensive, [presentation](https://github.com/mac999/multimodal_ai_learning/blob/main/AI_multimodal_tutorial.pdf), hands-on tutorial code(Colab, Python) with [syllabus](https://github.com/mac999/multimodal_ai_learning/blob/main/syllabus_multimodal_ai.pdf) for learning multimodal artificial intelligence through progressive implementation of foundational and advanced AI architectures. The curriculum is designed to take learners from basic machine learning concepts through cutting-edge multimodal models including Vision Transformers, CLIP and Vision-Language Models.
